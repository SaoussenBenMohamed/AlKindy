              ...
              <Row>
                <Col>
                  <ListGroup className="sticky-list">
                    <ListGroupItem tag="a" href="#2016" action>
                      Publications 2016
                    </ListGroupItem>
                    <ListGroupItem tag="a" href="#2015" action>
                      Publications 2015
                    </ListGroupItem>
                    <ListGroupItem tag="a" href="#2014" action>
                      Publications 2014
                    </ListGroupItem>
                    <ListGroupItem tag="a" href="#2013" action>
                      Publications 2013
                    </ListGroupItem>
                  </ListGroup>
                </Col>
                <Col md={10} style={{ marginTop: "30px" }}>
                  <Row style={{ marginBottom: "60px" }}>
                    ...
                    <Col>
                      <IconList data={fourth} />
                    </Col>
                  </Row>
                  <Row style={{ marginBottom: "60px" }}>
                    <div id="2015" className="anchor"></div>
                    <Col>
                      <IconList data={third} />
                    </Col>
                  </Row>
                  <Row style={{ marginBottom: "60px" }}>
                    <div id="2014" className="anchor"></div>
                    <Col>
                      <IconList data={second} />
                    </Col>
                  </Row>
                  <Row style={{ marginBottom: "60px" }}>
                    <div id="2013" className="anchor"></div>
                    <Col>
                      <IconList data={first} />
                    </Col>
                  </Row>
